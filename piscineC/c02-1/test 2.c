...
/*   Updated: 2019/09/10 18:24:22 by acarvaja         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*int main(void)
{
	...
	printf("Mi funcion: %u", ft_strlcpy(des, src, sizeof(des)));
	return (0);
}*/
...
void	print_special_chars(char *ptr, unsigned int size)
{
	int	j;
	char c;
